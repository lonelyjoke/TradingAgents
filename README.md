...
## News
- [2026-06] **A-share research system docs refreshed** with the current module map, 11 gated industry/sector toolkits, pre-LLM filing-text preflight, PM report structure, and debugging workflow. See [A-share current research system](docs/a_share_current_research_system.md) and [A-share version history](docs/a_share_version_history.md).
