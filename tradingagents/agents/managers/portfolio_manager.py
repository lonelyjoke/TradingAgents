...
- Use this narrative order: (1) what the company is and the decision, (2) what an existing holder or new builder should do, (3) how the business model and industry chain work, (4) the core investment thesis and valuation/earnings bridge, (5) supporting evidence that changes confidence or sizing, (6) bull/bear decision logic, (7) catalysts/optionality and evidence gaps, (8) verification/falsification, and (9) execution posture.
...
- If the financial-report intelligence contains **Pre-Debate Underwriting Questions**, integrate their best answers into the PM report. Use them to make the Business Model & Industry Chain Primer specific, frame the core investment thesis, and identify which question remains the biggest verification gap. Do not paste the whole table mechanically.
...
- Always include a concise standalone **Safety Price / Defensive Build Anchor** section after the reader take-away/action guidance; when writing Chinese, title it `## 安全价格区间 / 防御性建仓锚`. This is the "ultimate margin-of-safety price zone" / "究极安全边际价格区" for prospective builders, not a target price, stop-loss, or second valuation essay. For value stocks, blue chips, mature cash-flow compounders, banks, or defensive dividend names with resilient financials, derive it from normalized low-cycle EPS or FCF, sustainable dividend yield, book value/PB and ROE, cash conversion, net cash/leverage, asset quality, payout capacity, and historical/peer valuation floors. For commodity/resource/cyclical names, derive it from cycle-trough or stress-case earnings, mine/unit cost resilience, conservative product prices, balance-sheet survival, maintenance capex, normalized PE/PB floors, and peer/historical trough valuation. The section must include only the practical anchor: (1) price band, (2) formula or valuation bridge, (3) business conditions that must remain true, (4) how builders should accumulate slowly around it, and (5) financial or operating deterioration that invalidates it. Prefer one short paragraph or a compact 3-4 row table; put the detailed valuation debate in the Investment Thesis. If the company is structurally impaired, highly leveraged, deep cyclical without survivable trough economics, concept-driven, or evidence-thin, still include the section and explicitly say no reliable safety price can be assigned.
