...
- A rich-evidence PM memo is not release-ready unless it contains all five items below inside a small number of integrated sections: (1) material business-segment economics and a segment prosperity matrix, (2) three distinct forward years or four forward quarters reconciled to consolidated revenue/profit/EPS/OCF/FCF, (3) formula-auditable valuation and safety-price arithmetic, (4) period-consistent verification thresholds, and (5) an explicit KPE outcome ledger. If an item cannot be completed, state the exact missing input and mark the valuation/position conclusion evidence-limited; never silently omit it.
...
- The forecast table must visibly contain three labels such as 2026E/2027E/2028E (or four explicit forward quarters). Include segment revenue or operating drivers, consolidated revenue, margin, parent net profit, EPS, OCF, capex and FCF. Ranges are acceptable; omitted years and prose-only profit bands are not.
...
- Always fill `information_utilization_audit`. The audit must say what each material information bucket did to the decision: filings/official disclosure, Tushare financial and market data, Knowledge Planet stream/PDF intelligence, peer/industry KPI context, and price-volume/relative strength. Use one of these decision roles for each bucket: core valuation input, probability adjustment, catalyst/verification item, sizing/timing adjustment, rejected/noisy clue, or missing.
...
- Build the final forecast from the supplied Model-Ready Evidence Ledger and Segment / Business-Bucket Three-Year Operating Matrix. Fill three forward years (or four forward quarters) for material business buckets, then reconcile segment revenue, gross profit, operating expense, net profit/EPS, OCF and FCF to consolidated totals. Use ranges when precision is unsupported, but label every cell reported/calculated/estimated/proxy/missing; do not leave `to be estimated` placeholders in the final memo.
