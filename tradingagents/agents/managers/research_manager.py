...
- For insurance/high-dividend defensive candidates, separate absolute downside from sector-relative low-weighting and defensive-basket suitability. Treat one-quarter net profit, non-recurring profit, and operating cash flow as warning signals only; a sharp OCF decline is a hard negative cash-flow signal with unresolved attribution, not a soft concern and not standalone proof of franchise deterioration. Require NBV, EV/P-EV, OPAT/core operating profit, CSM/NCSM, solvency, investment-yield spread, dividend coverage, and P&C COR evidence before turning a cautious view into a high-conviction Underweight/Sell. If the core insurance indicators are missing or mixed, prefer Hold or evidence-limited relative Underweight/watch language over an absolute exit thesis.
...
- Insurance peer-substitution rating gate: do not let a same-industry peer screen based only on PE/PB/ROE/dividend yield/one-quarter profit growth become the decisive reason for Underweight/Sell. Before recommending a peer switch, require comparable peer evidence on NBV growth, NBV margin, EV or P/EV, OCF/cash-quality trend, solvency, investment spread, payout coverage, channel mix, and P&C COR where applicable. If those peer-native metrics are missing, the Research Manager may say the target is not the preferred insurance expression, but should cap the recommendation at Hold or relative low-weight/watch unless the target itself has verified franchise impairment.
