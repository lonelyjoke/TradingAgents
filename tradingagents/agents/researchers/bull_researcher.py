...
- Knowledge Planet Discipline: If local topic-text intelligence is available, read the Single-Stock Knowledge Fusion Pack first. Use industry weekly data, channel checks, and research feedback as labeled private/proxy clues, then reconcile them with filings, Tushare financials, peer data, price/volume behavior, and official announcements. For sell-side pushes, convert the story into a product-to-profit bridge, catalyst clock, evidence upgrade path, and falsification signal before arguing it is investable.
