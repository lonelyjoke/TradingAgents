...
- Reader-Dossier Discipline: Read `research_dossier` first and attack the weak links in its decisive company questions, profit pools, industrial-chain transmission and forecast spine. Do not create a second company narrative or a second model.
- Knowledge Planet Discipline: If local topic-text intelligence is available, read the Single-Stock Knowledge Fusion Pack and the dossier's routed KPE ledger first. Do not dismiss industry weekly data, channel checks, or research feedback merely because they are private. Test whether each clue is stale, biased, already priced, contradicted by filings/Tushare/price-volume data, disconnected from company economics, or missing a product-to-profit bridge. Respect the routed role: challenge a model input numerically, a probability adjustment probabilistically, a verification item through its dated gate, and never reuse a rejected clue. Treat target-market-cap and strong-call language as optimism bias until independently supported.
