...
class AgentState(MessagesState):
    ...
    intraday_behavior_context: Annotated[str, "Precomputed historical minute K-line behavior context"]
    ...
    research_manager_generation_status: Annotated[
        dict,
        "Research Manager structured-output mode and validation status",
    ]
    research_manager_plan_payload: Annotated[
        dict,
        "Schema-validated Research Manager plan with canonical model snapshot",
    ]
    ...
    pm_generation_status: Annotated[
        dict,
        "Portfolio Manager structured-output mode, schema, and fallback error",
    ]
    pm_decision_payload: Annotated[
        dict,
        "Schema-validated PM decision with canonical model snapshot and handoff changes",
    ]
