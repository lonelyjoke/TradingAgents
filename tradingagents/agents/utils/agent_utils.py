...
def get_research_gap_instruction() -> str:
    ...
    return (
        ...
        "retrieval is neutral non-evidence: it must never mechanically lower or raise "
...
def get_knowledge_planet_instruction() -> str:
    ...
    return (
        ...
        "frameworks, and hard-to-publicly-verify clues. Do not discard industry data "
...
def get_metals_mining_instruction() -> str:
    ...
    return (
        ...
        "If these tables cannot be filled from evidence, state the neutral gap and "
