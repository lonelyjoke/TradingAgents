...
def build_thesis_question_context(
    ...
    *,
    ...
    lines = [
        ...
        "- Debate use: the bull must answer the bull-proof column; the bear must attack the bear-attack column; unanswered questions remain neutral research tasks and must not mechanically change the rating.",
        "",
    ...
    lines.extend(
        [
            ...
            "- Missing evidence rule: a missing thesis-critical answer is neutral non-evidence. Keep unsupported SOTP/model cells null and add a retrieval task, but do not mechanically reduce the rating, conviction tier, or position size.",
