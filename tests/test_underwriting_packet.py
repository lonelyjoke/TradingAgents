...
class UnderwritingRepairOnlyLLM:
    def __init__(self):
        self.calls = 0
    ...
    def invoke(self, _prompt):
        ...
        payload = {
            ...
            "forecast_years": ["2026E", "2027E", "2028E"],
            "research_readiness": "partial",
            "readiness_reasons": ["Repaired without changing analysis."],
            "company_model": {
                "model_profile": "corporate",
                "business_archetype": "automotive component platform supplier",
                "revenue_equation": "volume x content per vehicle",
...
def test_underwriting_json_repair_routes_to_separate_model():
    primary = RepairingFakeLLM()
    repair = UnderwritingRepairOnlyLLM()
    packet = build_company_underwriting_packet(
        "601689.SH",
        "2026-06-29",
        contexts={"filing_intelligence": "汽车零部件平台供应商。"},
    ...
    assert packet["company_model"]["revenue_equation"] == "volume x content per vehicle"
