# Sell-Side Depth And Key-Number Audit for 603345.SH as of 2026-07-23
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; 缺少稀释后总股本数据，无法计算 EPS 及每股公允价值，所有 per-share 指标留空; 缺乏分产品线/子公司拆分收入与利润的权威数据，新宏业、新柳伍、鼎味泰的贡献无法量化建模，仅能做定性分析; 缺少2025年完整现金流量表及资本支出明细，OCF/capex 仅基于2026Q1 年化推导，缺乏全年实际数验证 |
...
| Hog-breeder valuation framework | partial | must use hog ASP x complete-cost spread, sales kg, PB/NAV floor, normalized cycle earnings, and implied hog price; PE TTM alone is not acceptable |
| Hog-cycle private-data bridge | partial | Knowledge Planet livestock clues must be extracted into hog price, piglet/sow price, breeding-sow inventory, cost, output, and cash-survival assumptions before affecting rating |
...
- Weak or incomplete modules: Shared company underwriting model, Valuation closure, Hog-breeder valuation framework, Hog-cycle private-data bridge
