# Market-expectation context for 002714.SZ as of 2026-06-08

- Company: 牧原股份
- Valuation trade date: 2026-06-08
...
| --- | --- | --- |
| Market cap (CNY) | 197147813707 | current equity value |
| PE TTM | 20.1563 | earnings multiple the market is paying now |
| PS TTM | 1.4288 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 9780952541.2402 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 137981392572.0885 | market cap divided by PS TTM |
| PE percentile | 69.5 | 5-year valuation position |
| PB percentile | 0.1 | 5-year valuation position |
| PS percentile | 0.7 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 15486891254.04 | 12.73 | 1.5834 |
