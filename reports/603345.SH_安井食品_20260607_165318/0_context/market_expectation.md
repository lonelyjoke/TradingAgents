# Market-expectation context for 603345.SH as of 2026-06-07
...
| --- | --- | --- |
| Market cap (CNY) | 28889484626 | current equity value |
| PE TTM | 18.9083 | earnings multiple the market is paying now |
| PS TTM | 1.6696 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 1527873189.3401 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 17303237078.3421 | market cap divided by PS TTM |
| PE percentile | 36.9 | 5-year valuation position |
| PB percentile | 19.6 | 5-year valuation position |
| PS percentile | 24.3 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 1359237139.62 | 21.2542 | 0.8896 |
| latest reported simple-run-rate parent profit (Q1) | 2252636482.44 | 12.8247 | 1.4744 |
| latest reported seasonality-adjusted parent profit (Q1) | 2105686773.3228 | 13.7197 | 1.3782 |
