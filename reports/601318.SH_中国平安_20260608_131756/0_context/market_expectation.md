# Market-expectation context for 601318.SH as of 2026-06-08
...
| --- | --- | --- |
| Market cap (CNY) | 968396693893 | current equity value |
| PE TTM | 7.293 | earnings multiple the market is paying now |
| PS TTM | 0.9346 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 132784408870.5608 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 1036161666908.838 | market cap divided by PS TTM |
| PE percentile | 8.6 | 5-year valuation position |
| PB percentile | 26.6 | 5-year valuation position |
| PS percentile | 69.4 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 134778000000 | 7.1851 | 1.015 |
| latest reported simple-run-rate parent profit (Q1) | 100088000000 | 9.6755 | 0.7538 |
| latest reported seasonality-adjusted parent profit (Q1) | 93272313150.0452 | 10.3825 | 0.7024 |
