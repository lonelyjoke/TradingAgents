# Market-expectation context for 300363.SZ as of 2026-08-13

- Company: 博腾股份
- Valuation trade date: 2026-08-13
...
| --- | --- | --- |
| Market cap (CNY) | 12151367592 | current equity value |
| PE TTM | 94.5711 | earnings multiple the market is paying now |
| PS TTM | 3.4672 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 128489227.597 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 3504663011.0752 | market cap divided by PS TTM |
| PE percentile | 82.1 | 5-year valuation position |
| PB percentile | 41.1 | 5-year valuation position |
| PS percentile | 51.8 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 96339888.88 | 126.1302 | 0.7498 |
| latest reported simple-run-rate parent profit (Q1) | 111460369.4 | 109.0196 | 0.8675 |
| latest reported seasonality-adjusted parent profit (Q1) | 84517802.3825 | 143.7729 | 0.6578 |
