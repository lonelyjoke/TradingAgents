# Market-expectation context for 300136.SZ as of 2026-08-21
...
| --- | --- | --- |
| Market cap (CNY) | 57686442198 | current equity value |
| PE TTM | 78.3695 | earnings multiple the market is paying now |
| PS TTM | 6.2983 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 736082815.3555 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 9159049616.2457 | market cap divided by PS TTM |
| PE percentile | 87.4 | 5-year valuation position |
| PB percentile | 87.7 | 5-year valuation position |
| PS percentile | 87.7 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 708686269.06 | 81.3991 | 0.9628 |
| latest reported simple-run-rate parent profit (Q1) | 419556560.96 | 137.4938 | 0.57 |
| latest reported seasonality-adjusted parent profit (Q1) | 504399714.1671 | 114.3665 | 0.6852 |
