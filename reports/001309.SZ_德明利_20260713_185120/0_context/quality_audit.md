# Sell-Side Depth And Key-Number Audit for 001309.SZ as of 2026-07-13
...
| --- | --- | --- |
| Shared company underwriting model | blocked | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; LLM company underwriting failed; only deterministic skeleton is available. |
...
- Weak or incomplete modules: Shared company underwriting model, Thesis-to-financial transmission, Moat evidence tests, Valuation closure
