# Market-expectation context for 689009.SH as of 2026-05-23
...
| --- | --- | --- |
| Market cap (CNY) | 28675031744 | current equity value |
| PE TTM | 19.0485 | earnings multiple the market is paying now |
| PS TTM | 1.3013 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 1505369543.2186 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 22035681045.1087 | market cap divided by PS TTM |
| PE percentile | 2.2 | 5-year valuation position |
| PB percentile | 3.2 | 5-year valuation position |
| PS percentile | 0.2 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | vs_implied_ttm_earnings |
| --- | --- | --- |
| latest annual parent profit | 1758171535.84 | 1.1679 |
| latest reported simple-run-rate parent profit (Q1) | 813470664.76 | 0.5404 |
| latest reported seasonality-adjusted parent profit (Q1) | 1932420454.3555 | 1.2837 |
