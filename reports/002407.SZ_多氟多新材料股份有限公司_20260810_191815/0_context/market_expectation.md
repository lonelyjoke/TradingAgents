# Market-expectation context for 002407.SZ as of 2026-08-10

- Company: 多氟多
- Valuation trade date: 2026-08-07
...
| --- | --- | --- |
| Market cap (CNY) | 43498403550 | current equity value |
| PE TTM | 83.0783 | earnings multiple the market is paying now |
| PS TTM | 4.1224 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 523583216.6763 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 10551718307.2967 | market cap divided by PS TTM |
| PE percentile | 80.1 | 5-year valuation position |
| PB percentile | 76.6 | 5-year valuation position |
| PS percentile | 76.3 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 212784849.4 | 204.4243 | 0.4064 |
| latest reported simple-run-rate parent profit (Q1) | 1502115741.12 | 28.9581 | 2.8689 |
| latest reported seasonality-adjusted parent profit (Q1) | 1234452637.3966 | 35.237 | 2.3577 |
