# Sell-Side Depth And Key-Number Audit for 002407.SZ as of 2026-08-10
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; LLM company underwriting failed; deterministic evidence remains usable and the missing analysis should be retried. |
...
| Thesis-to-financial transmission | partial | decisive claims need formulas and earnings/cash-or-capital/fair-value impact |
| Moat evidence tests | partial | claimed advantages require observable history/true-peer tests and counterevidence |
...
| Industry KPI checklist | partial | sector-native KPIs must be verified or listed as gaps |
| Three-year forecast bridge | partial | valuation must connect to revenue/profit/cash-flow assumptions |
...
| Battery KPI routing | partial | battery target lacks the battery/energy-storage KPI playbook or contains a conflicting telecom template; reroute before manager synthesis |
| Battery forecast bridge | partial | battery forecast must show segment GWh x ASP, segment margins, earnings/FCF conversion, scenario inputs, and monotonic valuation; missing or conflicting markers: gwh shipments x asp |
...
- Weak or incomplete modules: Shared company underwriting model, Thesis-to-financial transmission, Moat evidence tests, Valuation closure, Industry KPI checklist, Three-year forecast bridge, Battery KPI routing, Battery forecast bridge
