...
| --- | --- | --- |
| Market cap (CNY) | 1315282233840 | current equity value |
| PE TTM | 260.6807 | earnings multiple the market is paying now |
| PS TTM | 19.1622 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 5045568136.9584 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 68639416864.4519 | market cap divided by PS TTM |
| PE percentile | 99.4 | 5-year valuation position |
| PB percentile | 99.4 | 5-year valuation position |
| PS percentile | 99.4 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 5040734000 | 260.9307 | 0.999 |
| latest reported simple-run-rate parent profit (Q1) | 5444836000 | 241.5651 | 1.0791 |
| latest reported seasonality-adjusted parent profit (Q1) | 5407653975.3789 | 243.226 | 1.0718 |
