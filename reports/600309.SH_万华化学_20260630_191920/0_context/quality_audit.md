# Sell-Side Depth And Key-Number Audit for 600309.SH as of 2026-06-30
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; Key segment-level revenue/margin for polyurethane, petrochemical and fine chemicals are not disclosed separately; only a broad 'chemical industry' segment and tiny 'other' segment are reported. Without product-level economics the model cannot fully reflect polyurethane cycle or new-material contribution.; Diluted share count is not supplied and cannot be reliably calculated from the evidence; equity per-share values, EPS and per-share valuation closure remain open.; Capex, OCF and FCF data are unavailable for FY2025 or Q1 2026; the reinvestment and cash-flow equations are placeholder. |
