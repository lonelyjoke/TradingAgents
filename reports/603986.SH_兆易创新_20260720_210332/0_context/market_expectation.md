# Market-expectation context for 603986.SH as of 2026-07-20

- Company: 兆易创新
- Valuation trade date: 2026-07-20
...
| --- | --- | --- |
| Market cap (CNY) | 303364363500 | current equity value |
| PE TTM | 105.5312 | earnings multiple the market is paying now |
| PS TTM | 26.4198 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 2874641466.2204 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 11482462528.1039 | market cap divided by PS TTM |
| PE percentile | 56.1 | 5-year valuation position |
| PB percentile | 95.7 | 5-year valuation position |
| PS percentile | 96.3 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 1648022651.7 | 184.0778 | 0.5733 |
| latest reported simple-run-rate parent profit (Q1) | 5844993412.32 | 51.9016 | 2.0333 |
| latest reported seasonality-adjusted parent profit (Q1) | 5621189064.3226 | 53.968 | 1.9554 |
