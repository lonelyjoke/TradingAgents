# Compute-leasing verification layer for 600415.SH as of 2026-06-06

- Status: triggered
- Trigger verdict: triggered by multiple official weak compute signals plus monetization wording.
...
## Evidence Hits
| source | date | title | terms | grade | excerpt |
| --- | --- | --- | --- | --- | --- |
| interaction | nan | 董秘您好！公司23年投建的数据中心目前进展怎么样？什么时候能投入使用？ | 数据中心 | weak adjacency signal; requires stronger official evidence | 董秘您好！公司23年投建的数据中心目前进展怎么样？什么时候能投入使用？ 董秘您好！公司23年投建的数据中心目前进展怎么样？什么时候能投入使用？ 尊敬的投资者您好，感谢您对公司的关注！ directional-but-unquantified |
| interaction | 2026-05-15 | 您好，近年公司股价持续低迷、长期跑输市场，请问管理层是否复盘核心原因，是否存在经营效率与战略执行不足的问题？传统商贸及商铺租赁业务增长乏力，公司有无明确的新业务布局、打造第二增长曲线的规划？公司具备成 | 数据中心 | weak adjacency signal; requires stronger official evidence | ...价持续低迷、长期跑输市场，请问管理层是否复盘核心原因，是否存在经营效率与战略执行不足的问题？传统商贸及商铺租赁业务增长乏力，公司有无明确的新业务布局、打造第二增长曲线的规划？公司具备成熟的商业地产开发、物业运营及场地出租能力，建房商业出租与数据中心机房租赁运营逻辑相通，是否评估过切入数据中心赛道的可行性？当前市场环境快速变化，请问管理层是否会主动变通、优化经营模式，提升公司长期盈利 您好，近年公司股价持续低迷、长期跑输市场，请问管理层是否复盘核心原因，是否存在经营效率与战略执... |
| interaction | 2026-04-30 | 贵公司使用算力吗，算力是自己建数据中心吗 | 算力, 数据中心 | weak adjacency signal; requires stronger official evidence | 贵公司使用算力吗，算力是自己建数据中心吗 贵公司使用算力吗，算力是自己建数据中心吗 尊敬的投资者您好，感谢您对公司的关注！ directional-but-unquantified |
| interaction | 2026-04-30 | 贵公司有有数据中心业务吗 | 数据中心 | weak adjacency signal; requires stronger official evidence | 贵公司有有数据中心业务吗 贵公司有有数据中心业务吗 尊敬的投资者您好，感谢您对公司的关注！ directional-but-unquantified |
...
- announcement feed unavailable: anns unavailable: anns unavailable: configured_http_url: 请指定正确的接口名; cninfo announcement fallback unavailable: HTTPSConnectionPool(host='www.cninfo.com.cn', port=443): Read timed out. (read timeout=20)
- major news unavailable: major_news unavailable: major_news unavailable: configured_http_url: 请联系管理员添加此权限
- news feed unavailable: news unavailable: news unavailable: configured_http_url: 请联系管理员添加此权限; news unavailable: news unavailable: configured_http_url: 请联系管理员添加此权限; news unavailable: news unavailable: configured_http_url: 请联系管理员添加此权限; news unavailable: news unavailable: configured_http_url: 请联系管理员添加此权限; news unavailable: news unavailable: configured_http_url: 请联系管理员添加此权限