# Sell-Side Depth And Key-Number Audit for 300750.SZ as of 2026-07-01
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; 分部营收和毛利率可从2025年年报提取；缺少产能利用率、分产品均价和出货量，导致预测依赖粗略假设; 股份数量未从可靠来源获取，使用推算值并标记为计算值，可能影响每股指标精度; 资本开支和自由现金流缺乏具体数值，仅基于比例粗估 |
