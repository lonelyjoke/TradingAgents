# Sell-Side Depth And Key-Number Audit for 689009.SH as of 2026-08-03
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; Segment-level revenue, cost, and margin breakdown not available from filings; only qualitative product descriptions found.; Cash flow statement items (OCF, capex, FCF) not reported in deterministic evidence; only negative OCF/Net profit ratio in Q1 2026 available.; Forecast base case relies on unverified sell-side broker estimates (KPE05) rather than company-disclosed guidance; must be treated as analytical placeholder. |
