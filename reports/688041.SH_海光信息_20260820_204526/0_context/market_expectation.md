# Market-expectation context for 688041.SH as of 2026-08-20
...
| --- | --- | --- |
| Market cap (CNY) | 572554204173 | current equity value |
| PE TTM | 182.2314 | earnings multiple the market is paying now |
| PS TTM | 31.7879 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 3141907509.7541 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 18011702697.3471 | market cap divided by PS TTM |
| PE percentile | 64.2 | 5-year valuation position |
| PB percentile | 77.7 | 5-year valuation position |
| PS percentile | 43.8 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 2544890905.62 | 224.9818 | 0.81 |
| latest reported simple-run-rate parent profit (Q1) | 2748377346.84 | 208.3245 | 0.8747 |
| latest reported seasonality-adjusted parent profit (Q1) | 3733706884.2552 | 153.3474 | 1.1884 |
