# Industry Cycle Scan for 300274.SZ as of 2026-07-05
...
| --- | --- | --- |
| commodity/product price | range-bound / bottom-testing stage | Mapped product proxy moved -0.9% over the look-back window; price evidence alone does not prove a new upcycle. |
...
- | Rebar | steel cost proxy | Tushare futures proxy | RB.SHF | 3062 | 20260703 | -0.94% | N/A | Verified by Tushare futures daily data. | exchange=SHFE, query_exchange=SHF, prefix=RB, selected by open interest/volume; curve=RB2607.SHF close=3132, oi=13440, vol=3360 | RB2608.SHF close=3055, oi=2089, vol=699 | RB2609.SHF 
