# Market-expectation context for 605499.SH as of 2026-08-05

- Company: 东鹏饮料
- Valuation trade date: 2026-08-05
...
| --- | --- | --- |
| Market cap (CNY) | 89968783447 | current equity value |
| PE TTM | 18.3336 | earnings multiple the market is paying now |
| PS TTM | 3.9841 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 4907316808.8646 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 22581959149.3687 | market cap divided by PS TTM |
| PE percentile | 0.7 | 5-year valuation position |
| PB percentile | 2.6 | 5-year valuation position |
| PS percentile | 1 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 4415263147.79 | 20.3768 | 0.8997 |
| latest reported simple-run-rate parent profit (Q1) | 5029691001.16 | 17.8875 | 1.0249 |
| latest reported seasonality-adjusted parent profit (Q1) | 5452682640.9372 | 16.4999 | 1.1111 |
