# Sell-Side Depth And Key-Number Audit for 605499.SH as of 2026-08-05
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; Consolidated revenue, profit, margins, OCF and capex drivers sufficiently evidenced for three-year model.; Energy-drink segment dominates (71.92% of main-business revenue); absolute segment revenue/margin, electrolyte and international economics are missing but immaterial to consolidated forecast given their small weight.; Share count derived from market cap/close cross-check, EPS consistent with parent profit. |
...
| Valuation closure | ready | mutually exclusive buckets must reconcile to per-share value without double counting |
...
| Knowledge Planet intelligence | missing | private/proxy data must be separated from sell-side promotion and mapped into KPI/forecast assumptions |
...
- Weak or incomplete modules: Shared company underwriting model, Knowledge Planet intelligence
