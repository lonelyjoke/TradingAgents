# Market-expectation context for 300498.SZ as of 2026-06-24
...
| --- | --- | --- |
| Market cap (CNY) | 78449826447 | current equity value |
| PE TTM | 35.9351 | earnings multiple the market is paying now |
| PS TTM | 0.755 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 2183097485.3834 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 103907054896.6887 | market cap divided by PS TTM |
| PE percentile | 77.4 | 5-year valuation position |
| PB percentile | 3.1 | 5-year valuation position |
| PS percentile | 0.1 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 5266415817.82 | 14.8962 | 2.4124 |
| latest reported simple-run-rate parent profit (Q1) | -4280331811 | N/A | -1.9607 |
| latest reported seasonality-adjusted parent profit (Q1) | -2641285438.2828 | N/A | -1.2099 |
