# Earnings-model context for 300498.SZ as of 2026-06-24
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| latest reported | Q1 | 20260331 | 24525667199.71 | -1070082952.75 | 98102668798.84 | -4280331811 | 113960564708.8799 | -2641285438.2828 | historical median 0331 share 40.5% |
| latest annual | FY | 20251231 | 103824483312.07 | 5266415817.82 | 103824483312.07 | 5266415817.82 | 103824483312.07 | 5266415817.82 | FY actual |

## Operating Driver Bridge
| driver | latest_signal | change_vs_prior_report | model_role |
| --- | --- | --- | --- |
| Revenue base | 24525667199.71 | N/A | top-line starting point for volume × price × mix |
| Gross margin | 2.7079% | N/A | main bridge from demand to gross profit |
| Operating margin | -4.2997% | -9.92pp | tests pricing, mix, and cost absorption |
| Net margin | -4.3631% | -9.44pp | captures final earnings conversion |
| Finance-expense ratio | 0.7434% | +0.06pp | captures leverage drag or relief |
| OCF / net profit | -1.2046 | N/A | tests earnings quality and cash realization |
| Receivables / revenue | 1.4275% | -0.87pp | tests working-capital drag; interim periods use annualized revenue |
| Inventory / revenue | 21.2288% | +1.22pp | tests inventory build and demand quality; interim periods use annualized revenue |
