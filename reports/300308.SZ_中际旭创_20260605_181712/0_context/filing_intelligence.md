# Financial-report intelligence for 300308.SZ as of 2026-06-05
...
- Extraction status: Narrative filing text extraction unavailable: no readable annual, semiannual, or quarterly report body was retrieved. Treat this as a filing-text/segment-evidence gap, not as proof that structured financial statements failed.

## Financial Reports Considered
No recent quarterly/half-year/annual report announcements found.
...
| --- | --- | --- | --- | --- | --- |
| text_unavailable | none | annual/semiannual/quarterly | 0/5 | unavailable | Narrative filing text was not readable, so business-model, segment, and management-discussion evidence is unavailable. This does not by itself mean structured financial statements, market data, or peer data failed. |
...
| segment_economics_depth | Decide whether each business line has enough disclosed scale, growth, margin, cash quality, and valuation treatment. | Not enough direct filing evidence found in the readable report pack. | Core segments can support base-case value; thin or header-only second curves stay in SOTP/scenario value. | Require revenue, cost/gross margin, profit or cash-quality evidence by product, channel, geography, or business bucket. |
| footnote_radar | Surface decision-relevant notes that can hide risk or change confidence. | Not enough direct filing evidence found in the readable report pack. | Use footnotes as valuation modifiers for customer concentration, related parties, guarantees, litigation, impairment, and capitalization choices. | If note evidence is thin, avoid claiming footnote cleanliness; keep guarantees, litigation, impairment assumptions, and related parties on the checklist. |
...
| mdna_text_change | Read management wording changes, proof-backed claims, risk-language upgrades, and abnormal silence across reports. | Not enough direct filing evidence found in the readable report pack. | Use text changes to decide whether management is proving, softening, or avoiding a theme; do not let soft wording replace hard evidence. | Compare the next quarterly MD&A against annual/semiannual promises, especially on strategy, project ramp, risks, and cash conversion. |
...
| balance_sheet_forward_signals | Read balance-sheet leads before income-statement confirmation. | leverage_funding_growth: 20251231->20260331: revenue growth -49.02%, gross margin change 4.02pp, operating margin change 3.09pp, OCF/net profit 0.59, receivables/revenue change -4.63pp, inventory/revenue change -13.06pp, prepayment/revenue change 1.56pp, contr... | Contract liabilities and payables can signal demand/funding; receivables, inventory, prepayments, debt, and CIP can signal execution burden. | Track whether leading assets/liabilities convert into revenue, margin, and cash rather than reversals, impairments, or financing drag. |
...
| disclosure_quality_score | Grade whether filing disclosure is rich enough for a buy-side thesis or only a watchlist view. | Coverage grade text_unavailable; reports seen none; answered 0/5; core pack unavailable. Narrative filing text was not readable, so business-model, segment, and management-discussion evidence is unavailable. This does not by itself mean structured financial st... | High disclosure quality raises conviction; weak or partial coverage should cap sizing and push more assumptions into verification. | Improve confidence by retrieving missing annual/semiannual/quarterly text and answering unanswered thesis-critical filing questions. |
...
| filing_read_confidence_gap | Can we trust a strong conclusion from the available filings? | Narrative filing text was not readable, so business-model, segment, and management-discussion evidence is unavailable. This does not by itself mean structured financial statements, market data, or peer data failed. | Coverage: text_unavailable; reports seen: none | Cap conviction and explicitly name missing report types or unanswered thesis-critical questions. | Retrieve annual/semiannual/quarterly text and answer the core playbook with quantified evidence. |

## Core Discussion Promotion Queue
| topic | priority | evidence_basis | why_it_matters | valuation_treatment | verification_need |
| --- | --- | --- | --- | --- | --- |
| leverage_funding_growth | supporting | 20251231->20260331: revenue growth -49.02%, gross margin change 4.02pp, operating margin change 3.09pp, OCF/net profit 0.59, receivables/revenue change -4.63pp, inventory/revenue c... | The balance sheet is taking more of the burden for current growth, and financing cost is beginning to reflect it. | financial-relation thesis modifier | Use to challenge the durability of growth and the risk of future earnings drag. |

## Unanswered Filing Questions
| question_id | category | question | why_it_matters |
| --- | --- | --- | --- |
| generic_revenue_quality | revenue_quality | 收入增长是否有真实业务支撑，而非仅由应收或一次性因素堆出来？ | Still unresolved in the latest readable filings; Attack any divergence between reported growth and cash realization. |
| generic_profit_quality | profit_quality | 利润改善来自主业、价格、成本，还是投资收益/减值/公允价值等非经常因素？ | Still unresolved in the latest readable filings; Separate operating earnings from accounting or one-off noise. |
| generic_cash_conversion | cash_quality | 利润能否转成现金，还是被应收、存货、预付款拖住？ | Still unresolved in the latest readable filings; Use deteriorating working capital to challenge profit quality. |
| generic_capital_allocation | capital_allocation | 管理层把钱投向哪里，资本开支是否正在创造未来收益？ | Still unresolved in the latest readable filings; Question return on capital, empire building, or delayed payback. |
| generic_risk_disclosure | risk | 财报中新增或升级了哪些真正会改变股权价值的风险？ | Still unresolved in the latest readable filings; Surface tail risks the market may be underweighting. |
