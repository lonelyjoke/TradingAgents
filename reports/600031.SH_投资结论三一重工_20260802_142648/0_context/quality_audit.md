# Sell-Side Depth And Key-Number Audit for 600031.SH as of 2026-08-02
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; 2026Q1 consolidated P&L available but lack segment revenue/profit/margin by product and geography.; Company-reported segment revenue totals (11,176,325 unit ambiguous) cannot be reconciled to consolidated revenue of 89,231 mn CNY without original filing normalization.; Capex, gross margin for FY2025, and detailed cash-flow items (capex, OCF breakdown) are either missing or unverified; FCF and accompanying forecast lines are labeled missing until Q2/H1 2026 filings. |
