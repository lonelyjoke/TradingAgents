# Market-expectation context for 601689.SH as of 2026-06-29
...
| --- | --- | --- |
| Market cap (CNY) | 90975693660 | current equity value |
| PE TTM | 32.8978 | earnings multiple the market is paying now |
| PS TTM | 2.9885 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 2765403572.8833 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 30441925266.8563 | market cap divided by PS TTM |
| PE percentile | 27 | 5-year valuation position |
| PB percentile | 8.3 | 5-year valuation position |
| PS percentile | 6 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 2779071103.34 | 32.736 | 1.0049 |
| latest reported simple-run-rate parent profit (Q1) | 2207199715.44 | 41.2177 | 0.7981 |
| latest reported seasonality-adjusted parent profit (Q1) | 2600214199.5427 | 34.9878 | 0.9403 |
