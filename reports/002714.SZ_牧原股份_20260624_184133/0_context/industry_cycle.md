# Industry Cycle Scan for 002714.SZ as of 2026-06-24

- Cycle verdict: demand-and-channel cycle verification required
...
| --- | --- | --- |
| consumer staples/channel | demand-and-channel cycle verification required | Consumer context is available; sell-through, distributor inventory, promotion, raw-material costs, and contract liabilities should govern cycle language. |
...
- | Live hog futures | timely market-implied price signal | Tushare futures proxy | LH2607.DCE | 9885 | 20260624 | -12.13% | N/A | Verified by Tushare futures daily data. | exchange=DCE, query_exchange=DCE, prefix=LH, selected nearest active contract; main/open-interest contract kept as reference; main_contract=LH.DCE cl
