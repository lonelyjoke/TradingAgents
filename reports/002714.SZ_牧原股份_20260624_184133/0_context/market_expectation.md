# Market-expectation context for 002714.SZ as of 2026-06-24
...
| --- | --- | --- |
| Market cap (CNY) | 187795559880 | current equity value |
| PE TTM | 19.2001 | earnings multiple the market is paying now |
| PS TTM | 1.3611 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 9780967801.2094 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 137973374388.3624 | market cap divided by PS TTM |
| PE percentile | 61.4 | 5-year valuation position |
| PB percentile | 0.1 | 5-year valuation position |
| PS percentile | 0.4 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 15486891254.04 | 12.1261 | 1.5834 |
