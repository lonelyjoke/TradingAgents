...
| --- | --- | --- | --- | --- | --- |
| consolidated | segment revenue = volume/units x ASP/mix | to be estimated | to be estimated | to be estimated | base period=2025年度; reported revenue=423701834.0 (千元CNY); revenue weight=100.0%; growth=None%; gross margin=None%; margin change=Nonepp; source=earnings_model; mode=llm_semantic |
| 动力电池系统 | segment revenue = volume/units x ASP/mix | to be estimated | to be estimated | to be estimated | base period=2025年度; reported revenue=316506369.0 (千元CNY); revenue weight=74.7%; growth=25.08%; gross margin=23.84%; margin change=-0.1pp; source=company_business_model; mode=llm_semantic |
| 储能电池系统 | segment revenue = volume/units x ASP/mix | to be estimated | to be estimated | to be estimated | base period=2025年度; reported revenue=62439820.0 (千元CNY); revenue weight=14.7%; growth=8.99%; gross margin=26.71%; margin change=-0.13pp; source=company_business_model; mode=llm_semantic |
| 电池材料及回收 | segment revenue = volume/units x ASP/mix | to be estimated | to be estimated | to be estimated | base period=2025年度; reported revenue=21860936.0 (千元CNY); revenue weight=5.2%; growth=-23.83%; gross margin=27.27%; margin change=16.76pp; source=company_business_model; mode=llm_semantic |
| 电池矿产资源 | segment revenue = volume/units x ASP/mix | to be estimated | to be estimated | to be estimated | base period=2025年度; reported revenue=5978096.0 (千元CNY); revenue weight=1.4%; growth=8.83%; gross margin=11.25%; margin change=2.72pp; source=company_business_model; mode=llm_semantic |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| KPE01 | consolidated | utilization_or_backlog | None  | None | None | None | None | bull None->None; base None->None; bear None->None | unquantified | unchanged/watch: no model assumption or scenario probability change until 订单公告、排产环比、产能利用率、合同负债/预收款、收入确认节奏 | 订单金额, 排产数量, 收入影响 |
| KPE02 | 储能电池系统 | utilization_or_backlog | None  | None | None | None | None | bull None->None; base None->None; bear None->None | unquantified | unchanged/watch: no model assumption or scenario probability change until 订单公告、排产环比、产能利用率、合同负债/预收款、收入确认节奏 | 钠电出货量, 订单规模, 收入贡献 |
| KPE03 | consolidated | unmapped | None  | None | None | None | None | bull None->None; base None->None; bear None->None | unquantified | unchanged/watch: no model assumption or scenario probability change until 公告、财务、同行、价格成交、后续调研或可观察代理指标 | AIDC投资规模, 对储能订单的拉动, 收入量化 |
| KPE04 | consolidated | unmapped | None  | None | None | None | None | bull None->None; base None->None; bear None->None | unverified | unchanged/watch: no model assumption or scenario probability change until cross-check with filings/Tushare/price-volume/announcements before hard use | 研报具体内容, 估值目标, 盈利预测 |
| KPE05 | consolidated | unmapped | None  | None | None | None | None | bull None->None; base None->None; bear None->None | unverified | unchanged/watch: no model assumption or scenario probability change until cross-check with filings/Tushare/price-volume/announcements before hard use | 订单金额, 排产数量, 收入影响 |
| KPE06 | 储能电池系统 | utilization_or_backlog | None  | None | None | None | None | bull None->None; base None->None; bear None->None | unverified | unchanged/watch: no model assumption or scenario probability change until cross-check with filings/Tushare/price-volume/announcements before hard use | 钠电出货量, 订单规模, 收入贡献 |
| KPE07 | consolidated | unmapped | None  | None | None | None | None | bull None->None; base None->None; bear None->None | unverified | unchanged/watch: no model assumption or scenario probability change until cross-check with filings/Tushare/price-volume/announcements before hard use | AIDC投资规模, 对储能订单的拉动, 收入量化 |
| KPE08 | consolidated | unmapped | None  | None | None | None | None | bull None->None; base None->None; bear None->None | unverified | unchanged/watch: no model assumption or scenario probability change until cross-check with filings/Tushare/price-volume/announcements before hard use | 具体内容, 相关性 |
