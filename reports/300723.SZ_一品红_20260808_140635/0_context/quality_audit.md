# Sell-Side Depth And Key-Number Audit for 300723.SZ as of 2026-08-08
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; 2025 annual report PDF unreadable (EV004); 2026 Q1 PDF unreadable (EV005); only supplemental cached text recovered (EV008). Core financial statements for FY2025 and interim periods are missing.; Disclosure quality is weak/thin: coverage grade weak, reports seen quarterly, 2/5 core questions answered (EV037). Segment-level P&L, cash flow, capex, and working capital detail unavailable beyond a few Q1 metrics.; Market data (daily_basic) unavailable due to timeout (EV041); price/PE used from decomposition module (EV044-EV045). |
