# Web fact-check context for 300723.SZ as of 2026-08-08

- Company: 一品红
- Industry: 化学制药
- Purpose: corroborate biopharma facts that filings and Tushare may lag, such as clinical-trial status, CDE/NMPA/FDA/EMA regulatory updates, approved labels, reimbursement/pricing, commercialization, cash-runway commentary, and for CRO/CDMO names order-cycle or geopolitical-risk signals.
...
## Search Queries
- 一品红 临床 管线 适应症 NMPA FDA
- 一品红 CDE NMPA FDA 获批
- 一品红 医保 商业化 现金流

## Search Evidence
No web fact rows found.

## Relevance Filter
- Filtered out 12 search result(s) that did not mention the company name, ticker, or stable company alias.
