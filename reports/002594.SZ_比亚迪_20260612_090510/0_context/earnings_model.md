# Earnings-model context for 002594.SZ as of 2026-06-12
...
| --- | --- | --- | --- |
| Revenue base | 150225314000 | N/A | top-line starting point for volume × price × mix |
| Gross margin | 18.8062% | +1.06pp | main bridge from demand to gross profit |
| Operating margin | 3.1259% | -1.87pp | tests pricing, mix, and cost absorption |
| Net margin | 2.7189% | -1.34pp | captures final earnings conversion |
| Finance-expense ratio | 1.3978% | +1.48pp | captures leverage drag or relief |
| OCF / net profit | 0.6831 | N/A | tests earnings quality and cash realization |
| Receivables / revenue | 7.3593% | +2.36pp | tests working-capital drag; interim periods use annualized revenue |
| Inventory / revenue | 26.6955% | +9.48pp | tests inventory build and demand quality; interim periods use annualized revenue |
