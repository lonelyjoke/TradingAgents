# Sell-Side Depth And Key-Number Audit for 600426.SH as of 2026-08-02
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; 缺少分产品（尤其是煤化工基础产品与新材料）的收入、成本、毛利、销量及实现价格数据; 化工新材料分部及荆州项目投产时间、资本开支、预期回报等关键数据缺失; 公司整体FY2025毛利率、营业利润、资本支出等需从完整年报补充 |
