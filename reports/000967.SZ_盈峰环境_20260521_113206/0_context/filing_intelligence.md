...
| --- | --- | --- | --- | --- | --- |
| failed | none | annual/semiannual/quarterly | 0/5 | unavailable | No readable report text; deep filing read did not complete. |
...
| --- | --- | --- | --- | --- | --- |
| filing_read_confidence_gap | Can we trust a strong conclusion from the available filings? | No readable report text; deep filing read did not complete. | Coverage: failed; reports seen: none | Cap conviction and explicitly name missing report types or unanswered thesis-critical questions. | Retrieve annual/semiannual/quarterly text and answer the core playbook with quantified evidence. |
