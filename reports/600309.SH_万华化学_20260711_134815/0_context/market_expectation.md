# Market-expectation context for 600309.SH as of 2026-07-11
...
| --- | --- | --- |
| Market cap (CNY) | 215094703636 | current equity value |
| PE TTM | 16.3411 | earnings multiple the market is paying now |
| PS TTM | 1.0041 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 13162804440.0928 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 214216416329.0509 | market cap divided by PS TTM |
| PE percentile | 59 | 5-year valuation position |
| PB percentile | 6.9 | 5-year valuation position |
| PS percentile | 5.5 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 12527201094.15 | 17.1702 | 0.9517 |
| latest reported simple-run-rate parent profit (Q1) | 14870831495.72 | 14.4642 | 1.1298 |
| latest reported seasonality-adjusted parent profit (Q1) | 13159633283.9537 | 16.345 | 0.9998 |
