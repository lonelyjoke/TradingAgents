# Sell-Side Depth And Key-Number Audit for 000528.SZ as of 2026-07-07
...
| Industry cycle stage | partial | cycle verdict must precede valuation language |
...
| Battery forecast bridge | partial | battery forecast must show segment GWh x ASP, segment margins, earnings/FCF conversion, scenario inputs, and monotonic valuation; missing or conflicting markers: gwh shipments x asp, segment revenue x segment gross margin |
...
- Weak or incomplete modules: Shared company underwriting model, Valuation closure, Industry cycle stage, Three-year forecast bridge, Battery forecast bridge
