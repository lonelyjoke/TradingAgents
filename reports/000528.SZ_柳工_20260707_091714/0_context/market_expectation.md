# Market-expectation context for 000528.SZ as of 2026-07-07
...
| --- | --- | --- |
| Market cap (CNY) | 16848671961 | current equity value |
| PE TTM | 10.8137 | earnings multiple the market is paying now |
| PS TTM | 0.4947 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 1558085757.9737 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 34058362565.191 | market cap divided by PS TTM |
| PE percentile | 14.8 | 5-year valuation position |
| PB percentile | 33.9 | 5-year valuation position |
| PS percentile | 41.2 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 1609225714.3 | 10.47 | 1.0328 |
| latest reported simple-run-rate parent profit (Q1) | 2424233450.12 | 6.9501 | 1.5559 |
| latest reported seasonality-adjusted parent profit (Q1) | 1546886610.9183 | 10.892 | 0.9928 |
