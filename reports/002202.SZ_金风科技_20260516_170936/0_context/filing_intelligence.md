...
| --- | --- | --- | --- | --- |
| generic_revenue_quality | 收入增长是否有真实业务支撑，而非仅由应收或一次性因素堆出来？ | 2 | 2026-05-16 | quarterly |
| generic_profit_quality | 利润改善来自主业、价格、成本，还是投资收益/减值/公允价值等非经常因素？ | 2 | 2026-05-16 | quarterly |
| generic_cash_conversion | 利润能否转成现金，还是被应收、存货、预付款拖住？ | 2 | 2026-05-16 | quarterly |
| generic_capital_allocation | 管理层把钱投向哪里，资本开支是否正在创造未来收益？ | 2 | 2026-05-16 | annual |
| generic_risk_disclosure | 财报中新增或升级了哪些真正会改变股权价值的风险？ | 2 | 2026-05-16 | annual |
| equipment_orders | 新增订单、在手订单、合同负债与收入确认是否同向？ | 1 | 2026-05-16 | quarterly |
| equipment_mix | 高毛利新品类是否已形成可单独验证的收入与毛利贡献？ | 1 | 2026-05-16 | annual |
