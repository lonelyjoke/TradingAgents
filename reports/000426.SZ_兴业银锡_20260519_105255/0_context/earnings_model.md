# Earnings-model context for 000426.SZ as of 2026-05-19
...
| --- | --- | --- | --- | --- | --- | --- |
| latest reported | Q1 | 20260331 | 2129869142.28 | 1337672163.55 | 8519476569.12 | 5350688654.2 |
| latest annual | FY | 20251231 | 5555253610.07 | 1704239280.88 | 5555253610.07 | 1704239280.88 |

## Operating Driver Bridge
| driver | latest_signal | change_vs_prior_report | model_role |
| --- | --- | --- | --- |
| Revenue base | 2129869142.28 | N/A | top-line starting point for volume × price × mix |
| Gross margin | 69.0663% | N/A | main bridge from demand to gross profit |
| Operating margin | 68.948% | +30.82pp | tests pricing, mix, and cost absorption |
| Net margin | 62.8054% | +32.13pp | captures final earnings conversion |
| Finance-expense ratio | 3.9125% | -0.03pp | captures leverage drag or relief |
| OCF / net profit | 0.9097 | N/A | tests earnings quality and cash realization |
| Receivables / revenue | 0.5792% | -0.11pp | tests working-capital drag; interim periods use annualized revenue |
| Inventory / revenue | 4.0953% | -6.25pp | tests inventory build and demand quality; interim periods use annualized revenue |
