# Web fact-check context for 300274.SZ as of 2026-07-04
...
## Relevance Filter
- Filtered out 4 search result(s) that did not mention the company name, ticker, or stable company alias.
- Context unavailable: search provider returned no relevant web fact rows after company relevance filtering.

## Search Errors
- Search provider errors on 1 query path(s); treat this context as unavailable rather than evidence.
