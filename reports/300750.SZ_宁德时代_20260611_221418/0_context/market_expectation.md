# Market-expectation context for 300750.SZ as of 2026-06-11

- Company: 宁德时代
- Valuation trade date: 2026-06-11
...
| --- | --- | --- |
| Market cap (CNY) | 1768296904374.0002 | current equity value |
| PE TTM | 22.3902 | earnings multiple the market is paying now |
| PS TTM | 3.7774 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 78976378253.611 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 468125404874.7817 | market cap divided by PS TTM |
| PE percentile | 29.1 | 5-year valuation position |
| PB percentile | 33.6 | 5-year valuation position |
| PS percentile | 54.9 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 72201282000 | 24.4912 | 0.9142 |
| latest reported simple-run-rate parent profit (Q1) | 82950840000 | 21.3174 | 1.0503 |
| latest reported seasonality-adjusted parent profit (Q1) | 103559726364.7439 | 17.0751 | 1.3113 |
