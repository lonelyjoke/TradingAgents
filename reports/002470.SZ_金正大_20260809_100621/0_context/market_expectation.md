# Market-expectation context for 002470.SZ as of 2026-08-08
...
| --- | --- | --- |
| Market cap (CNY) | 6407754015 | current equity value |
| PE TTM | 172.097 | earnings multiple the market is paying now |
| PS TTM | 0.6089 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 37233385.9103 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 10523491566.7597 | market cap divided by PS TTM |
| PE percentile | 67.1 | 5-year valuation position |
| PB percentile | 87.3 | 5-year valuation position |
| PS percentile | 17.5 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 34595438.67 | 185.2196 | 0.9292 |
| latest reported simple-run-rate parent profit (Q1) | 45764980.92 | 140.0143 | 1.2291 |
| latest reported seasonality-adjusted parent profit (Q1) | 77327758.1912 | 82.8649 | 2.0768 |
