# Earnings-model context for 600519.SH as of 2026-06-18
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| latest reported | Q1 | 20260331 | 53909252220.51 | 27242512886.45 | 215637008882.04 | 108970051545.8 | 203332203034.943 | 97759052639.0058 | historical median 0331 share 27.9% |
| latest annual | FY | 20251231 | 168838102514.79 | 82320067101.68 | 168838102514.79 | 82320067101.68 | 168838102514.79 | 82320067101.68 | FY actual |

## Operating Driver Bridge
| driver | latest_signal | change_vs_prior_report | model_role |
| --- | --- | --- | --- |
| Revenue base | 53909252220.51 | N/A | top-line starting point for volume × price × mix |
| Gross margin | 89.7592% | -1.42pp | main bridge from demand to gross profit |
| Operating margin | 69.63% | +1.63pp | tests pricing, mix, and cost absorption |
| Net margin | 50.534% | +1.78pp | captures final earnings conversion |
| Finance-expense ratio | -0.2148% | +0.27pp | captures leverage drag or relief |
| OCF / net profit | 0.9878 | N/A | tests earnings quality and cash realization |
| Receivables / revenue | 0.015% | -0.01pp | tests working-capital drag; interim periods use annualized revenue |
| Inventory / revenue | 28.1456% | -8.24pp | tests inventory build and demand quality; interim periods use annualized revenue |
