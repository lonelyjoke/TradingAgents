# Market-expectation context for 601600.SH as of 2026-06-02
...
| --- | --- | --- |
| Market cap (CNY) | 193679626282 | current equity value |
| PE TTM | 13.2083 | earnings multiple the market is paying now |
| PS TTM | 0.7943 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 14663478743.0631 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 243836870555.2058 | market cap divided by PS TTM |
| PE percentile | 26.8 | 5-year valuation position |
| PB percentile | 87.2 | 5-year valuation position |
| PS percentile | 92 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 12673918000 | 15.2817 | 0.8643 |
| latest reported simple-run-rate parent profit (Q1) | 22108980000 | 8.7602 | 1.5078 |
| latest reported seasonality-adjusted parent profit (Q1) | 20133862217.7392 | 9.6196 | 1.3731 |
