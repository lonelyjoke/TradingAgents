# Market-expectation context for 600415.SH as of 2026-06-05
...
| --- | --- | --- |
| Market cap (CNY) | 64760834459 | current equity value |
| PE TTM | 14.7497 | earnings multiple the market is paying now |
| PS TTM | 3.032 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 4390654349.5122 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 21359114267.4802 | market cap divided by PS TTM |
| PE percentile | 4 | 5-year valuation position |
| PB percentile | 55.5 | 5-year valuation position |
| PS percentile | 3.4 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 4203546946.97 | 15.4062 | 0.9574 |
| latest reported simple-run-rate parent profit (Q1) | 3961770776.96 | 16.3464 | 0.9023 |
| latest reported seasonality-adjusted parent profit (Q1) | 2876451509.4066 | 22.5141 | 0.6551 |
