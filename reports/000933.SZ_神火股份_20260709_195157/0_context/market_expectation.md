# Market-expectation context for 000933.SZ as of 2026-07-09

- Company: 神火股份
- Valuation trade date: 2026-07-09
...
| --- | --- | --- |
| Market cap (CNY) | 48016243940 | current equity value |
| PE TTM | 8.5946 | earnings multiple the market is paying now |
| PS TTM | 1.0908 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 5586792164.8477 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 44019292207.5541 | market cap divided by PS TTM |
| PE percentile | 53.7 | 5-year valuation position |
| PB percentile | 8.6 | 5-year valuation position |
| PS percentile | 68.1 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 4005359185.05 | 11.988 | 0.7169 |
| latest reported simple-run-rate parent profit (Q1) | 9158767532.68 | 5.2427 | 1.6394 |
| latest reported seasonality-adjusted parent profit (Q1) | 8969255072.5972 | 5.3534 | 1.6054 |
