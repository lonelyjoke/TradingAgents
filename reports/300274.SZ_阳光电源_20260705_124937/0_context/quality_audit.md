# Sell-Side Depth And Key-Number Audit for 300274.SZ as of 2026-07-05
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; Segments lack reported revenue/volume/margin breakdown; segment economics rely on analytical mapping.; Diluted share count cannot be confirmed from supplied evidence (no close price or total_share from Tushare).; AIDC energy storage and SST are in early commercialization with only private proxy evidence; forward revenue/profit assumptions are unverified. |
