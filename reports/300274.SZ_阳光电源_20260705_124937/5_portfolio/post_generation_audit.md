...
- BLOCKED: blocking_errors=1, research_errors=2, warnings=12.
...
| industry_playbook_alignment | error | blocks formal publication | saved contexts mix wind/offshore equipment evidence with lithium-battery playbook, supply-chain, or forecast drivers |