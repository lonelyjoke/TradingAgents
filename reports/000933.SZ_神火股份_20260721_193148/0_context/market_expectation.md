# Market-expectation context for 000933.SZ as of 2026-07-21

- Company: 神火股份
- Valuation trade date: 2026-07-21
...
| --- | --- | --- |
| Market cap (CNY) | 55010647624 | current equity value |
| PE TTM | 9.8466 | earnings multiple the market is paying now |
| PS TTM | 1.2497 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 5586765748.9895 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 44019082679.043 | market cap divided by PS TTM |
| PE percentile | 69.9 | 5-year valuation position |
| PB percentile | 32.1 | 5-year valuation position |
| PS percentile | 79.7 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 4005359185.05 | 13.7343 | 0.7169 |
| latest reported simple-run-rate parent profit (Q1) | 9158767532.68 | 6.0063 | 1.6394 |
| latest reported seasonality-adjusted parent profit (Q1) | 8969255072.5972 | 6.1332 | 1.6054 |
