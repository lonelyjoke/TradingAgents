# Market-expectation context for 300751.SZ as of 2026-05-16
...
| --- | --- | --- |
| Market cap (CNY) | 72553501765 | current equity value |
| PE TTM | 107.0817 | earnings multiple the market is paying now |
| PS TTM | 9.9934 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 677552763.5908 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 7260141870.1343 | market cap divided by PS TTM |
| PE percentile | 83.2 | 5-year valuation position |
| PB percentile | 60.7 | 5-year valuation position |
| PS percentile | 54.3 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | vs_implied_ttm_earnings |
| --- | --- | --- |
| latest annual parent profit | 721615400.43 | 1.065 |
| latest reported annualized parent profit (Q1) | 472081837 | 0.6967 |
