# Earnings-model context for 002202.SZ as of 2026-05-16

- Company: 金风科技
- Purpose: convert the thesis into a disciplined earnings bridge instead of a free-floating narrative.

## Earnings Snapshots
| snapshot | period | end_date | revenue | net_profit_parent | annualized_revenue | annualized_net_profit_parent |
| --- | --- | --- | --- | --- | --- | --- |
| latest reported | Q1 | 20260331 | 15484910567.73 | 907191653.85 | 61939642270.92 | 3628766615.4 |
| latest annual | FY | 20251231 | 73023477737.27 | 2774356663.48 | 73023477737.27 | 2774356663.48 |

## Operating Driver Bridge
| driver | latest_signal | change_vs_prior_report | model_role |
| --- | --- | --- | --- |
| Revenue base | 15484910567.73 | N/A | top-line starting point for volume × price × mix |
| Gross margin | 16.7629% | +2.58pp | main bridge from demand to gross profit |
| Operating margin | 8.2218% | +2.68pp | tests pricing, mix, and cost absorption |
| Net margin | 5.8586% | +2.06pp | captures final earnings conversion |
| Finance-expense ratio | 1.6201% | +0.63pp | captures leverage drag or relief |
| OCF / net profit | -1.7049 | N/A | tests earnings quality and cash realization |
| Receivables / revenue | 55.7948% | +10.67pp | tests working-capital drag; interim periods use annualized revenue |
| Inventory / revenue | 27.6677% | +4.55pp | tests inventory build and demand quality; interim periods use annualized revenue |
