# Earnings-model context for 601600.SH as of 2026-06-04
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| latest reported | Q1 | 20260331 | 58494089000 | 5527245000 | 233976356000 | 22108980000 | 238155925123.4716 | 20133862217.7392 | historical median 0331 share 27.5% |
| latest annual | FY | 20251231 | 241125217000 | 12673918000 | 241125217000 | 12673918000 | 241125217000 | 12673918000 | FY actual |

## Operating Driver Bridge
| driver | latest_signal | change_vs_prior_report | model_role |
| --- | --- | --- | --- |
| Revenue base | 58494089000 | N/A | top-line starting point for volume × price × mix |
| Gross margin | 25.8276% | +7.80pp | main bridge from demand to gross profit |
| Operating margin | 20.3453% | +9.64pp | tests pricing, mix, and cost absorption |
| Net margin | 9.4492% | +4.19pp | captures final earnings conversion |
| Finance-expense ratio | 0.961% | +0.06pp | captures leverage drag or relief |
| OCF / net profit | 1.9687 | N/A | tests earnings quality and cash realization |
| Receivables / revenue | 3.3588% | +0.79pp | tests working-capital drag; interim periods use annualized revenue |
| Inventory / revenue | 10.47% | +0.51pp | tests inventory build and demand quality; interim periods use annualized revenue |
