# Market-expectation context for 002156.SZ as of 2026-07-16
...
| --- | --- | --- |
| Market cap (CNY) | 119450051999 | current equity value |
| PE TTM | 82.5857 | earnings multiple the market is paying now |
| PS TTM | 4.0753 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 1446376939.337 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 29310738350.3055 | market cap divided by PS TTM |
| PE percentile | 83.1 | 5-year valuation position |
| PB percentile | 100 | 5-year valuation position |
| PS percentile | 100 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 1218708143.38 | 98.0137 | 0.8426 |
| latest reported simple-run-rate parent profit (Q1) | 1316229602.2 | 90.7517 | 0.91 |
| latest reported seasonality-adjusted parent profit (Q1) | 2879505918.6377 | 41.4828 | 1.9908 |
