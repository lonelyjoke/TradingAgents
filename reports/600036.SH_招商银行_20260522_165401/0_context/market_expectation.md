# Market-expectation context for 600036.SH as of 2026-05-22

- Company: N/A
- Valuation trade date: 2026-05-22
...
| --- | --- | --- |
| Market cap (CNY) | 933638684149 | current equity value |
| PE TTM | 6.1934 | earnings multiple the market is paying now |
| PS TTM | 2.7402 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 150747357533.6649 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 340719175297.0586 | market cap divided by PS TTM |
| PE percentile | 30.3 | 5-year valuation position |
| PB percentile | 5.1 | 5-year valuation position |
| PS percentile | 41.9 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | vs_implied_ttm_earnings |
| --- | --- | --- |
| latest annual parent profit | 150181000000 | 0.9962 |
| latest reported simple-run-rate parent profit (Q1) | 151408000000 | 1.0044 |
| latest reported seasonality-adjusted parent profit (Q1) | 146258131492.2424 | 0.9702 |
