# Market-expectation context for 002840.SZ as of 2026-06-24
...
| --- | --- | --- |
| Market cap (CNY) | 5944053024 | current equity value |
| PE TTM | N/A | earnings multiple the market is paying now |
| PS TTM | 0.7565 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | N/A | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 7857307368.1428 | market cap divided by PS TTM |
| PE percentile | 74.4 | 5-year valuation position |
| PB percentile | 0.1 | 5-year valuation position |
| PS percentile | 12.6 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | -136017659.72 | N/A | N/A |
| latest reported simple-run-rate parent profit (Q1) | -962318053.44 | N/A | N/A |
| latest reported seasonality-adjusted parent profit (Q1) | -1391445699.2414 | N/A | N/A |
