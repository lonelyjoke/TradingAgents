# Price-move attribution context for 002840.SZ as of 2026-06-24
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 002840.SZ | 华统股份 | 食品 | 7.41 | -5.1216 | -21.6702 | -42.7357 | -46.3821 | 0.6443 | 2.2013 | N/A | N/A | 1.6528 |

## Attribution Residual Table
| bucket | proxy | one_day_pct | target_minus_proxy |
| --- | --- | --- | --- |
| market | SSE/CSI median | 0.4804 | -5.602 |
| same_metal_equities | 食品 | N/A | N/A |
| cross_metal_equities | all configured metal equity baskets | 0.9735 | -6.0952 |
...
- web_search 华统股份 大跌 原因: skipped low-signal result 数字校园产品应用.
- web_search 华统股份 大跌 原因: skipped low-signal result 用户中心——首页.
- web_search 华统股份 大跌 原因: skipped low-signal result 账号管理——基本信息.
- web_search 华统股份 下跌 传闻: skipped low-signal result 半导体芯片制程中SOI衬底的详解； - 知乎.
- web_search 华统股份 下跌 传闻: skipped low-signal result 什麼是固態繼電器？I-autoc固態繼電器(SSR)原理、5大優勢與應用完整解析.
- web_search 华统股份 下跌 传闻: skipped low-signal result 什么是SOI衬底？ - 知乎.
- web_search 食品 板块 大跌 原因: skipped low-signal result GitHub - milvus-io/milvus: Milvus is a high-performance, clo.
- web_search 食品 板块 大跌 原因: skipped low-signal result GitHub - chroma-core/chroma: Search infrastructure for AI.
- web_search 食品 板块 大跌 原因: skipped low-signal result GitHub - pgvector/pgvector: Open-source vector similarity se.
