# Market-expectation context for 002714.SZ as of 2026-06-17
...
| --- | --- | --- |
| Market cap (CNY) | 202343509800 | current equity value |
| PE TTM | 20.6875 | earnings multiple the market is paying now |
| PS TTM | 1.4665 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 9780955156.4955 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 137977163177.6338 | market cap divided by PS TTM |
| PE percentile | 73.9 | 5-year valuation position |
| PB percentile | 0.1 | 5-year valuation position |
| PS percentile | 2.1 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 15486891254.04 | 13.0655 | 1.5834 |
| latest reported simple-run-rate parent profit (Q1) | -4859365217.4 | N/A | -0.4968 |
| latest reported seasonality-adjusted parent profit (Q1) | -4255059329.9534 | N/A | -0.435 |
