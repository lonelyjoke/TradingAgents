# Sell-Side Depth And Key-Number Audit for 601888.SH as of 2026-06-30
...
| --- | --- | --- |
| Shared company underwriting model | partial | shared company model must contain operating equations, material segments, underwriting questions, three-year forecasts and scenarios; Segment-level channel breakdown (Hainan offshore, airport, online, DFS) not disclosed; revenue/profit-weight allocation is missing.; Q1 2025 comparable revenue/earnings figures absent; YoY growth rates are inferred from margin changes only.; No sell-side consensus or internal baseline forecasting assumptions supplied; forecast scaffold uses Q1 2026 annualised/reference PDF figures. |
