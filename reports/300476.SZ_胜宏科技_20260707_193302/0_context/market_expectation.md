# Market-expectation context for 300476.SZ as of 2026-07-07

- Company: 胜宏科技
- Valuation trade date: 2026-07-07
...
| --- | --- | --- |
| Market cap (CNY) | 280015045216 | current equity value |
| PE TTM | 59.8352 | earnings multiple the market is paying now |
| PS TTM | 13.6596 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 4679771191.8068 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 20499505491.8153 | market cap divided by PS TTM |
| PE percentile | 79.9 | 5-year valuation position |
| PB percentile | 89.1 | 5-year valuation position |
| PS percentile | 85.8 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 4311988274.4 | 64.9387 | 0.9214 |
| latest reported simple-run-rate parent profit (Q1) | 5153710369.84 | 54.3327 | 1.1013 |
| latest reported seasonality-adjusted parent profit (Q1) | 6447499562.463 | 43.43 | 1.3777 |
