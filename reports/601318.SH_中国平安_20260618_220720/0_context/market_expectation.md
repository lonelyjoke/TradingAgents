# Market-expectation context for 601318.SH as of 2026-06-18

- Company: 中国平安
- Valuation trade date: 2026-06-01
...
| --- | --- | --- |
| Market cap (CNY) | 975096521430.9999 | current equity value |
| PE TTM | 7.3435 | earnings multiple the market is paying now |
| PS TTM | 0.9411 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 132783621084.088 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 1036124239114.8654 | market cap divided by PS TTM |
| PE percentile | 1.5 | 5-year valuation position |
| PB percentile | 16.1 | 5-year valuation position |
| PS percentile | 56.8 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 134778000000 | 7.2348 | 1.015 |
| latest reported simple-run-rate parent profit (Q1) | 100088000000 | 9.7424 | 0.7538 |
| latest reported seasonality-adjusted parent profit (Q1) | 93272313150.0452 | 10.4543 | 0.7024 |
