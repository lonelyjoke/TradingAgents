# Market-expectation context for 603986.SH as of 2026-07-19
...
| --- | --- | --- |
| Market cap (CNY) | 325013196750 | current equity value |
| PE TTM | 113.0622 | earnings multiple the market is paying now |
| PS TTM | 28.3051 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 2874640655.7629 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 11482495972.4573 | market cap divided by PS TTM |
| PE percentile | 61 | 5-year valuation position |
| PB percentile | 96.5 | 5-year valuation position |
| PS percentile | 96.7 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 1648022651.7 | 197.214 | 0.5733 |
| latest reported simple-run-rate parent profit (Q1) | 5844993412.32 | 55.6054 | 2.0333 |
| latest reported seasonality-adjusted parent profit (Q1) | 5621189064.3226 | 57.8193 | 1.9554 |
