# Market-expectation context for 603345.SH as of 2026-06-15

- Company: 安井食品
- Valuation trade date: 2026-06-15
...
| --- | --- | --- |
| Market cap (CNY) | 29612721608 | current equity value |
| PE TTM | 19.3817 | earnings multiple the market is paying now |
| PS TTM | 1.7114 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 1527870187.2385 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 17303214682.7159 | market cap divided by PS TTM |
| PE percentile | 39.3 | 5-year valuation position |
| PB percentile | 23.4 | 5-year valuation position |
| PS percentile | 28.1 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 1359237139.62 | 21.7863 | 0.8896 |
| latest reported simple-run-rate parent profit (Q1) | 2252636482.44 | 13.1458 | 1.4744 |
| latest reported seasonality-adjusted parent profit (Q1) | 2105686773.3228 | 14.0632 | 1.3782 |
