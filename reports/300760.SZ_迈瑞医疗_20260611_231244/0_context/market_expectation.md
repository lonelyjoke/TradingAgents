# Market-expectation context for 300760.SZ as of 2026-06-11
...
| --- | --- | --- |
| Market cap (CNY) | 178083391951 | current equity value |
| PE TTM | 22.7238 | earnings multiple the market is paying now |
| PS TTM | 5.3323 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 7836866719.0787 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 33397106680.2318 | market cap divided by PS TTM |
| PE percentile | 3.1 | 5-year valuation position |
| PB percentile | 0.9 | 5-year valuation position |
| PS percentile | 0.6 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 8135775409 | 21.8889 | 1.0381 |
| latest reported simple-run-rate parent profit (Q1) | 9318632020 | 19.1105 | 1.1891 |
| latest reported seasonality-adjusted parent profit (Q1) | 9454888707.6933 | 18.8351 | 1.2065 |
