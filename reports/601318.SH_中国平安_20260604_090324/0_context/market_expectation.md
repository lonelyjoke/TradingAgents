# Market-expectation context for 601318.SH as of 2026-06-04
...
| --- | --- | --- |
| Market cap (CNY) | 972380375132 | current equity value |
| PE TTM | 7.323 | earnings multiple the market is paying now |
| PS TTM | 0.9385 | sales multiple the market is paying now |
| Implied TTM earnings (CNY) | 132784429213.7102 | market cap divided by PE TTM |
| Implied TTM sales (CNY) | 1036100559543.9531 | market cap divided by PS TTM |
| PE percentile | 9.3 | 5-year valuation position |
| PB percentile | 27.2 | 5-year valuation position |
| PS percentile | 69.8 | 5-year valuation position |

## Earnings Benchmarks Versus Implied TTM Earnings
| benchmark | value | implied_pe_at_benchmark_profit | vs_implied_ttm_earnings |
| --- | --- | --- | --- |
| latest annual parent profit | 134778000000 | 7.2147 | 1.015 |
| latest reported simple-run-rate parent profit (Q1) | 100088000000 | 9.7153 | 0.7538 |
| latest reported seasonality-adjusted parent profit (Q1) | 93272313150.0452 | 10.4252 | 0.7024 |
